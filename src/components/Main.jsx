...
import DIAF_Poster from '../img/MULTI-PAIRING_poster.jpg'

const MainPage = ({ isWideScreen }) => {
  return (
    <div className="main-content">
      ...
      <h3>2023 디지털아트 페스티벌: 멀티페어링<br />
        2023 DIAF: MULTI-PAIRING
      </h3>
      <h3>2023.06.30 - 07.02 | 10:00 - 18:00 | 서울예술대학교 ATEC</h3>
